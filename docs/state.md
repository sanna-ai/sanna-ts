...
<!-- generated: 2026-05-01T23:41:24Z  git-sha: 6964e7fb95fe -->
...
|---|---|---|---|
| @sanna-ai/core | 1.5.0 | 41 | Core library for the Sanna protocol |
...
**Aggregate test files:** 57 (`packages/*/tests/**/*.test.ts`)
